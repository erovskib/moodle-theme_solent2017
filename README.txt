...
This document describes how to copy and customise the solent2017 (bootstrapbase) theme so that
...
From your Moodle theme directory right click on solent2017 and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of solent2017.
...
underscores. For the purpose of this tutorial we will call the theme 'solent2017theme'.

On opening 'solent2017theme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case solent2017. So using the above list as
a guide, search through and change all the instances of the theme name
'solent2017' to 'solent2017theme'. This includes the filename of the lang/en/theme_solent2017.php.
You need to change this to 'theme_solent2017theme.php'.
...
and then click on (solent2017theme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the solent2017 theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > solent2017

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/solent2017_theme
