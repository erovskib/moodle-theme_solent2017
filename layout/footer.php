		...
		<div class="row">
			<div class="medium-3 f-column stack">
				<nav class="nav">
					...
					<ul class="vertical">
						<li><a class="footer__item nav__item" href="/succeed">Succeed@Solent</a></li>
			...
			<div class="medium-3 f-column stack">
				<nav class="nav">
					...
					<ul class="vertical">
						...
						<li><a class="footer__item nav__item" href="https://graduatejobs.solent.ac.uk/" target="_blank">Solent Graduate Jobs</a></li>
						<li><a class="footer__item nav__item" href="http://portal.solent.ac.uk/careers/essential-info/events/events-listing.aspx" target="_blank">Events &amp; Workshops</a></li>
					</ul>
				</nav>
			</div>
			<div class="medium-3 f-column stack">
				<nav class="nav">
					<h3 class="footer__title footer__item nav__item">Solent Online Learning</h3>
					<ul class="vertical">
						...
						<li><a class="footer__item nav__item" href="/terms">Terms &amp; Conditions</a></li>                                             
						...
						<li><a class="footer__item nav__item" href="https://docs.moodle.org/30/en/Main_page" target="_blank">Moodle Documentation</a></li>
					</ul>
				</nav>
			</div>
		</div>
